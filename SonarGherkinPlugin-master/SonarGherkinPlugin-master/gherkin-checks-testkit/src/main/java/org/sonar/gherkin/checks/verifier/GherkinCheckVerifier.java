...
//    while(actualIssues.hasNext())
//    {
//    	Issue issue_new=actualIssues.next();
//    	System.out.println("actual issues: " +  issue_new.toString());
//    } 
    System.out.println("expected issues: " +  expectedIssues);
    
    for (TestIssue expected : expectedIssues) {
//    	System.out.println("actual has next: " + actualIssues.hasNext());
//    	System.out.println("actual next: " + actualIssues.next());
